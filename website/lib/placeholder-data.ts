...
export const placeholderProjects: PlaceholderProject[] = [
  ...
  },
  {
    id: "11",
    slug: "aisearcharena",
    name: "AISearchArena.com",
    tagline: "AI Search Engine Benchmark",
    description: "Compare and benchmark AI search engines head-to-head. Vote on results, track performance, and discover which AI search tool works best for your queries.",
    status: "active",
    liveUrl: "https://aisearcharena.com",
    githubUrl: null,
    featured: false,
    techStack: ["Next.js", "Tailwind CSS", "Neon", "Netlify"],
    category: "AI_TOOLS",
    metrics: {
      mrr: 0,
      users: 0,
    },
    launchedAt: new Date("2025-03-01"),
